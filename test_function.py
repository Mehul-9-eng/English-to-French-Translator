...
def decode_sequence(test_input):
  ...
  # Populating the first token of target sequence with the start token.
  target_seq[0, 0, target_features_dict['<START>']] = 1.

  # Sampling loop for a batch of sequences
  # (to simplify, here I am assuming a batch of size 1).
  decoded_sentence = ''
...
# Range is the number of sentences to be translated
